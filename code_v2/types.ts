...
export interface AnalysisResult {
  ...
  plan_of_action: string | string[]; // Can be string or array of strings based on your Flask output
  full_text: string; // The original full text from the AI for reference
}
